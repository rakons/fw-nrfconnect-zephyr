 ...
 *
 * @note Function limits number of writes to target by writting only words that are different in
 ...
 * @retval false During writting one of the old values differs from the target one.
 */
